...
**Website:** http://<BR>
**Code:** https://github.com/ArcStation13/ArcStation13 <BR>
**Wiki** http:///wiki/Main_Page <BR>
**IRC:** irc://irc.rizon.net/ or if you dont have an IRC client, you can click  [here](https://kiwiirc.com/client/irc.rizon.net:6667/?&theme=cli#).<BR>
...
Option 1:
Follow this: http://wiki/Setting_up_git
...
code tab of https://github.com/ArcStation13/ArcStation13
...
Arc Station currently comes equipped with seven maps all built by /tg/ developers. We are currently working on our own custom map. So there will be eight.
...
Anytime you want to make changes to a map it's imperative you use the [Map Merging tools](http:///wiki/Map_Merger)

##AWAY MISSIONS

Arc Station supports loading away missions however they are disabled by default.
