...
*/
        ...
        #include "map_files\ArcStation\arcstation-WIP-v1.dmm"
		...
		#define MAP_PATH "map_files/ArcStation"
        #define MAP_FILE "arcstation-WIP-v1.dmm"
        #define MAP_NAME "Arc Station"
	...
	#warn a map has already been included, ignoring Arc Station.
